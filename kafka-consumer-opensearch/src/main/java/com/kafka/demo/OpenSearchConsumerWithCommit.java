...
public class OpenSearchConsumerWithCommit {
    public static final Logger log = LoggerFactory.getLogger(OpenSearchConsumerWithCommit.class.getSimpleName());
    ...
    public static void main(String[] args) throws IOException {
        ...
        try(openSearchClient; consumer) {
            ...
            while(true){
                ...
                log.info("consumer offsets has been committed - {} record{s}", count);
                consumer.commitSync();
            }
        }
    }
